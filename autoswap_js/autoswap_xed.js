...
function write_csv(time, diff, price) {
    ...
    fs_csv.appendFileSync("C:/Users/radli/code/documentation/plt/doc/buy_xed.csv", `${time},${diff},${price}\r\n`);
...
function write_txt(time, first_coin_amount, first_coin, you_will_get, you_will_get_uniswap, second_coin, difference_in_dollar, trigger_amount) {
    ...
    fs_txt.appendFileSync("C:/Users/radli/code/documentation/txt/doc/buy_xed.txt", `${time}\n`)
    fs_txt.appendFileSync("C:/Users/radli/code/documentation/txt/doc/buy_xed.txt", 'For ' + first_coin_amount + ' ' + first_coin + ' you get:\n')
    fs_txt.appendFileSync("C:/Users/radli/code/documentation/txt/doc/buy_xed.txt", (you_will_get).toFixed(2) + ' ' + second_coin + ' on Pancakeswap\n')
    fs_txt.appendFileSync("C:/Users/radli/code/documentation/txt/doc/buy_xed.txt", (you_will_get_uniswap).toFixed(2) + ' ' + second_coin + ' on Uniswap\n')
    fs_txt.appendFileSync("C:/Users/radli/code/documentation/txt/doc/buy_xed.txt", 'The difference is: ' + (difference_in_dollar).toFixed(2) + ' $' + ' (tolerance = ' + trigger_amount + ')\n\n')
}
...
async function get_info(first_coin, second_coin, first_coin_amount, trigger_amount) {
    try {
        ...
        console.log(err)
        var fs = require('fs')
        fs.writeFileSync("txt/suicide.txt", 'YES')
...
async function main() {
    var fs = require('fs')
    fs.writeFileSync("C:/Users/radli/code/documentation/txt/doc/buy_xed.txt", '')
    var fs_csv = require('fs')
    fs_csv.writeFileSync("C:/Users/radli/code/documentation/plt/doc/buy_xed.csv", 'time,diff,price\r\n')
    ...
    await get_info(String(txt_data[1]), 'XED', String(txt_data[0]), toleranz)
}

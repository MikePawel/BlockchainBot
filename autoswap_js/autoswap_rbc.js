...
function write_csv(time, diff, price) {
    ...
    fs_csv.appendFileSync("C:/Users/radli/code/documentation/plt/doc/buy_rbc.csv", `${time},${diff},${price}\r\n`);
...
function write_txt(time, first_coin_amount, first_coin, you_will_get, you_will_get_uniswap, second_coin, difference_in_dollar, trigger_amount) {
    ...
    fs_txt.appendFileSync("C:/Users/radli/code/documentation/txt/doc/buy_rbc.txt", `${time}\n`)
    fs_txt.appendFileSync("C:/Users/radli/code/documentation/txt/doc/buy_rbc.txt", 'For ' + first_coin_amount + ' ' + first_coin + ' you get:\n')
    fs_txt.appendFileSync("C:/Users/radli/code/documentation/txt/doc/buy_rbc.txt", (you_will_get).toFixed(2) + ' ' + second_coin + ' on Pancakeswap\n')
    fs_txt.appendFileSync("C:/Users/radli/code/documentation/txt/doc/buy_rbc.txt", (you_will_get_uniswap).toFixed(2) + ' ' + second_coin + ' on Uniswap\n')
    fs_txt.appendFileSync("C:/Users/radli/code/documentation/txt/doc/buy_rbc.txt", 'The difference is: ' + (difference_in_dollar).toFixed(2) + ' $' + ' (tolerance = ' + trigger_amount + ')\n\n')
...
async function main() {
    var fs = require('fs')
    fs.writeFileSync("C:/Users/radli/code/documentation/txt/doc/buy_rbc.txt", '')
    var fs_csv = require('fs')
    fs_csv.writeFileSync("C:/Users/radli/code/documentation/plt/doc/buy_rbc.csv", 'time,diff,price\r\n')
    ...
    await get_info(String(txt_data[1]), 'RBC', String(txt_data[0]), toleranz)
}
